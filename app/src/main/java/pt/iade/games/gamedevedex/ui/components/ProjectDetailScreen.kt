...
//    val exampleAssets = listOf(
//        ProjectAsset(uri = "example1.png", description = "Screenshot 1"),
//        ProjectAsset(uri = "example2.png", description = "Screenshot 2")
//    )
